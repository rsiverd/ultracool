...
#
# Attempt to fit a single WCS to the 4-sensor mosaic using a radial
# distortion model (known a priori) and an affine transform (also known
# a priori) to unify the pixel coordinates of the four sensors. WCS will
# be fit to the NE sensor.
#
# Rob Siverd
# Created:       2026-05-05
...
######################################################################
# CHANGELOG (41_test_fit_4pack_xform.py):
#---------------------------------------------------------------------
#
#  2026-05-05:
#     -- Increased __version__ to 0.0.1.
#     -- First created 41_test_fit_4pack_xform.py.
#
