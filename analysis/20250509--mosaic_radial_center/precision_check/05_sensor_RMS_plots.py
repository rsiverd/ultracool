...
#
# Make per-sensor RMS plots and evaluate if the different chips
# behave similarly enough to treat with a single noise model.
#
# Rob Siverd
# Created:       2026-01-13
...
######################################################################
# CHANGELOG (05_sensor_RMS_plots.py):
#---------------------------------------------------------------------
#
#  2026-01-13:
#     -- Increased __version__ to 0.0.1.
#     -- First created 05_sensor_RMS_plots.py.
#
