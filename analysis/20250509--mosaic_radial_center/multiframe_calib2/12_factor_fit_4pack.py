...
#
# This is a clone of 11_test_fit_4pack.py that I am using to factor out
# the important parts of the solver.
#
# Rob Siverd
# Created:       2026-01-27
...
sys.stderr.write("setting limiting magnitude ... ")
...
## Load files, set Gaia epoch, insert SNR:
cdata, chdrs, stars = slvh.load_fcats(cpath)
...
#shrink_this = partial(slvh.fmin_squared_residuals_foc2ccd_rdist, unsquared=False, snrweight=False)
shrink_this = partial(spt.fmin_squared_residuals_foc2ccd_rdist, 
...
sifted_pars = spt.sift_params(fitted_pars)
...
def lnlike(params):
    ...
    residuals = spt.squared_residuals_foc2ccd_rdist(params,
                                        dataset=use_gstars, snrweight=True)
...
######################################################################
# CHANGELOG (12_factor_fit_4pack.py):
#---------------------------------------------------------------------
#
#  2026-04-28:
#     -- Increased __version__ to 0.1.0.
#     -- Implemented loose/bright initial fit (significant improvement).
#
#  2026-01-27:
#     -- Increased __version__ to 0.0.1.
#     -- First created 12_factor_fit_4pack.py.
#
