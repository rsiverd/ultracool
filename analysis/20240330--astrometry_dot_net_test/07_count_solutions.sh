#!/bin/bash
#
# Count how many times each image was solved. Any singles?
#
# Rob Siverd
# Created:      2024-07-03
...
save_file="counts.txt"

##**************************************************************************##
##==========================================================================##
##--------------------------------------------------------------------------##

ls solutions/*.pickle | sed 's|^.*/||' | cut -d. -f1 > $foo
cmde "wc -l $foo"
...
######################################################################
# CHANGELOG (07_count_solutions.sh):
#---------------------------------------------------------------------
#
#  2024-07-03:
#     -- Increased script_version to 0.01.
#     -- First created 07_count_solutions.sh.
#
