...
#
# Select fcat files corresponding to specific parts of the sky.
#
# Rob Siverd
# Created:       2021-01-11
...
if __name__ == '__main__':
    ...
    descr_txt = """
    Separate fcat files according to object.
    ...
    parser.set_defaults(fcat_list='fcat_list.txt')
    parser.set_defaults(targ_list='targets_deg.txt')
    # ------------------------------------------------------------------
...
##--------------------------------------------------------------------------##
## Load list of objects and coordinates:
...
######################################################################
# CHANGELOG (03_group_by_coords.py):
#---------------------------------------------------------------------
#
#  2021-01-11:
#     -- Increased __version__ to 0.1.0.
#     -- First created 03_group_by_coords.py.
#
