...
#
# Quick-and-dirty attempt at astrometric fits for WIRCam calib1 field.
#
# Rob Siverd
# Created:       2023-07-27
...
centroid_colmap = {
        'simple'    :   (    'dra',     'dde',        'x',        'y'),
        'window'    :   (   'wdra',    'wdde',       'wx',       'wy'),
        'tpcalc'    :   ('calc_ra', 'calc_de', 'xdw_cs23', 'ydw_cs23'),
        }
...
data_file = 'process/calib1_H2_fcat.pickle'
#targets = {}
with open(data_file, 'rb') as pp:
    targets = pickle.load(pp)
...
######################################################################
# CHANGELOG (25_cfht_quick_astrom.py):
#---------------------------------------------------------------------
#
#  2023-07-27:
#     -- Increased __version__ to 0.0.1.
#     -- First created 25_cfht_quick_astrom.py.
#
