...
#
# Find extracted catalogs, augment them with Earth ephemeris data, and
...
if __name__ == '__main__':
    ...
    parser.set_defaults(input_flavor='p')
    parser.set_defaults(output_flavor='p_eph')
