...
_ppa['cryo'][0] = np.array([+2.783938E-02, +2.046231E-02, -3.609477E-03, -7.669185E-01, +3.232491E-02, +1.276753E-01, +5.724266E-01, -1.491381E-01, -5.018244E-01, +2.857436E-01, +1.270852E+00, +7.535925E-02, +1.313992E-03, -1.956625E-01, -4.658775E-01, -2.770535E+00, +6.981738E-01, +1.554831E+00, -6.419691E-02, +7.382683E-01, -1.262995E+00])
_ppb['cryo'][0] = np.array([-2.831900E-03, +7.436390E-05, -4.321248E-02, -5.004743E-02, +2.975831E-02, -2.752005E-02, +7.136074E-02, -3.121356E-01, +3.678197E-01, +9.041720E-02, +1.646660E-01, -2.555968E-02, -1.893717E-01, -1.369838E-01, -2.143417E-01, -3.711832E-01, +2.288625E-01, -9.326759E-01, +8.925945E-01, -9.874694E-01, +1.274447E-01])
_ppa['cryo'][1] = np.array([+1.560036E-02, -8.046778E-02, +4.347387E-03, -4.658847E-01, +2.773967E-03, +5.260310E-03, +6.406896E-01, -1.433339E-01, +1.236054E-02, +8.189350E-02, +3.777830E-01, -4.622371E-05, +6.629448E-02, -6.734899E-02, -1.666788E-01, -1.160999E+00, +5.561046E-01, +1.101566E-02, -3.533757E-02, -8.704616E-01, -3.367478E-01])
_ppb['cryo'][1] = np.array([-4.911884E-03, -1.597777E-02, -8.055713E-02, -1.993140E-02, +1.408297E-03, -1.959913E-01, +1.738639E-01, -1.320856E-01, +6.978489E-02, +2.124757E-01, -7.466133E-02, -8.647830E-02, +1.998463E-01, -3.775696E-02, +1.012916E-01, -5.557408E-01, -4.995205E-01, +6.448413E-02, +9.568401E-01, -1.708307E-01, +1.892472E-01])
_ppa['cryo'][2] = np.array([-2.958072E-02, +2.026849E-02, -7.964571E-02, -3.297237E-01, +7.959587E-02, +6.688262E-04, +4.893981E-02, +3.205900E-01, +1.701601E+00, +8.494186E-01, +1.167754E+00, -1.866597E-01, -6.758463E-02, -9.820143E-02, -1.786983E-01, -4.945196E-01, -6.789277E-01, -3.755359E+00, -1.419667E+00, -6.513492E+00, -2.141430E+00])
_ppb['cryo'][2] = np.array([+4.889141E-03, +4.892661E-02, -2.633427E-02, -9.054284E-02, -1.235002E-01, -3.679879E-01, -8.481535E-01, +2.337722E-02, -9.665800E-01, +4.488875E-01, +3.975577E-01, +2.139587E-01, -1.885543E-01, +7.415889E-01, +7.630252E-01, +3.191154E+00, +4.774575E-01, +4.692128E+00, -4.824242E-01, +1.946208E+00, -1.692083E+00])
_ppa['cryo'][3] = np.array([-7.716998E-02, +3.117923E-01, +5.264274E-02, +1.326105E-02, +1.599413E-03, -2.830490E-01, -2.083720E+00, -3.426859E-01, +1.393718E+00, -4.865320E-01, -4.885021E-01, -6.302262E-01, +1.673146E+00, +2.399258E-01, +1.044011E+00, +3.354562E+00, -1.340646E+00, +2.386917E-01, +5.725999E+00, -9.903208E+00, +3.530657E-01])
_ppb['cryo'][3] = np.array([-3.592878E-02, +3.136689E-02, +2.694646E-01, -4.197915E-01, +1.979760E-01, +3.747094E-02, -1.068913E+00, +8.309793E-01, +1.578866E-02, -9.650013E-01, +1.333649E+00, -9.932210E-01, +1.172701E+00, -8.285775E-01, -1.223195E+00, +2.984574E+00, -4.530653E+00, +2.838048E+00, -2.905586E+00, -8.142194E-01, +3.327983E-01])
#_ppa['cryo'] = _aaa
#_ppb['cryo'] = _bbb

## Warm mission parameters:
_ppa['warm'][0] = np.array([+5.298110E-02, -1.031251E-01, +3.433206E-04, -7.190475E-01, -5.493761E-03, +3.039381E-02, +1.368275E+00, -4.923920E-02, -2.766547E-01, +9.866965E-03, +7.050155E-01, +6.951617E-02, -2.790677E-02, +3.136094E-02, +4.057089E-02, -3.810908E+00, +1.158134E-01, +7.586575E-01, -4.799565E-02, +1.531817E-01, -3.483019E-02])
_ppb['warm'][0] = np.array([+1.243723E-02, -2.326365E-03, -1.560887E-01, -6.648988E-02, +3.912225E-02, -1.279622E-01, +2.325948E-02, +2.361877E-02, +5.564555E-02, +2.068253E-01, +1.747259E-01, -1.176636E-01, +1.084111E-01, -1.289356E-01, -8.817560E-03, -1.606868E-01, -2.181416E-01, -1.361416E-01, -1.593799E-01, +9.579846E-02, +1.682768E+00])
_ppa['warm'][1] = np.array([+4.050731E-02, -1.887555E-01, -1.919032E-02, -4.133482E-01, +3.262207E-04, +2.888772E-03, +8.406737E-01, +1.438462E-01, +3.580412E-02, +1.716415E-01, -9.744711E-02, +5.304771E-02, -3.940930E-02, -9.872928E-04, -4.662450E-02, -3.890232E-01, -4.835268E-01, +5.128984E-01, -1.795073E-01, -6.409911E-01, -4.390934E-01])
_ppb['warm'][1] = np.array([+1.260093E-02, -1.665688E-02, -1.549771E-01, -2.083848E-02, +3.977243E-02, -2.426269E-01, +1.287132E-01, -1.318016E-02, +6.500871E-02, +3.146763E-01, +1.297098E-02, +6.563227E-03, +3.919026E-02, -1.990932E-01, +6.797772E-02, -2.070237E-01, -5.477868E-01, -2.156148E-01, +7.003856E-01, -2.158017E-01, +1.085267E+00])
#_ppa['warm'] = _aaa
#_ppb['warm'] = _bbb
